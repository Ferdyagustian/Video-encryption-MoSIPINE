...
def pencet1():     
    ...
    def encrypt():
        ...
        P_r = np.array([nilai(pixel_values[i][0]) for i in range(height*width)]).reshape(array.shape[0], array.shape[1])
        P_g = np.array([nilai(pixel_values[i][1]) for i in range(height*width)]).reshape(array.shape[0], array.shape[1])
        P_b = np.array([nilai(pixel_values[i][2]) for i in range(height*width)]).reshape(array.shape[0], array.shape[1])
        ...
        # Enkripsi XOR langsung per-channel RGB
        enkripsi_r = np.zeros((height, width), dtype=np.uint8)
        enkripsi_g = np.zeros((height, width), dtype=np.uint8)
        enkripsi_b = np.zeros((height, width), dtype=np.uint8)
        for i in range(height):
            for j in range(width):
                enkripsi_r[i,j] = int(P_r[i][j]) ^ int(A[i][j])
                enkripsi_g[i,j] = int(P_g[i][j]) ^ int(A[i][j])
                enkripsi_b[i,j] = int(P_b[i][j]) ^ int(A[i][j])
    
        GambarCoba = (np.dstack((enkripsi_r, enkripsi_g, enkripsi_b)).astype('uint8'))
        Hasil1234 = PIL.Image.fromarray(GambarCoba)
        toc=timeit.default_timer()
        Hasil1234.save('Tempat_gambar/Citra - Hasil Enkripsi.gif')
        Hasil1234.save('Tempat_gambar/Citra - Hasil Enkripsi.png')
...
def pencet2():
    ...
    def encrypt():
        ...
        # Dekripsi XOR langsung per-channel RGB (simetris dengan enkripsi)
        enkripsi_r = np.zeros((height, width), dtype=np.uint8)
        enkripsi_g = np.zeros((height, width), dtype=np.uint8)
        enkripsi_b = np.zeros((height, width), dtype=np.uint8)
        for i in range(height):
        ...
        Hasil1234 = PIL.Image.fromarray(GambarCoba)
        toc=timeit.default_timer()
        Hasil1234.save('Tempat_gambar/Citra - Hasil Dekripsi.gif')
        Hasil1234.save('Tempat_gambar/Citra - Hasil Dekripsi.png')
        ...
        a = str(toc - tic)
        l33 =Label(F6, font=("Segoe UI",10), text='Waktu: ' +' '+ a[:5] + ' detik', bd=1, relief="ridge")
...
def pencet3():
    ...
    Judul1 = Label(Frr1, font=("Segoe UI",15), text="Uji Kualitas Citra Digital", bd=1, relief="ridge")
    Judul1.pack()
    ...
    def hasil():
        ...
        im1 = PIL.Image.open("Tempat_gambar/img1.png", "r")
        ...
        im2 = PIL.Image.open("Tempat_gambar/img2.png", "r")
        ...
        lp1= Label(Fr5, font=("Segoe UI",10), text='Koefisien Korelasi \n Image 1', bd=1, relief="ridge")
        lp1.place(x=0, y=50)
        
        ls1= Label(Fr5, font=("Segoe UI",10), text='R', bd=1, relief="ridge")
        ls1.place(x=120, y=30)
        
        ls2= Label(Fr5, font=("Segoe UI",10), text='G', bd=1, relief="ridge")
        ls2.place(x=120, y=60)
        
        ls3= Label(Fr5, font=("Segoe UI",10), text='B', bd=1, relief="ridge")
        ls3.place(x=120, y=90)
        
        lp2= Label(Fr5, font=("Segoe UI",10), text='Horizontal', bd=1, relief="ridge")
        lp2.place(x=150, y=0)
        
        lp3= Label(Fr5, font=("Segoe UI",10), text='Vertikal', bd=1, relief="ridge")
        lp3.place(x=250, y=0)
        
        lp4= Label(Fr5, font=("Segoe UI",10), text='Diagonal', bd=1, relief="ridge")
        lp4.place(x=350, y=0)
        
        lp5= Label(Fr5, font=("Segoe UI",10), text=cov1[:7], bd=1, relief="ridge")
        lp5.place(x=150, y=30)
        
        lp6= Label(Fr5, font=("Segoe UI",10), text=cov2[:7], bd=1, relief="ridge")
        lp6.place(x=150, y=60)
        
        lp7= Label(Fr5, font=("Segoe UI",10), text=cov3[:7], bd=1, relief="ridge")
        lp7.place(x=150, y=90)
        
        lp8= Label(Fr5, font=("Segoe UI",10), text=cov4[:7], bd=1, relief="ridge")
        lp8.place(x=250, y=30)
        
        lp9= Label(Fr5, font=("Segoe UI",10), text=cov5[:7], bd=1, relief="ridge")
        lp9.place(x=250, y=60)
        
        lp10= Label(Fr5, font=("Segoe UI",10), text=cov6[:7], bd=1, relief="ridge")
        lp10.place(x=250, y=90)
        
        lp11= Label(Fr5, font=("Segoe UI",10), text=cov7[:7], bd=1, relief="ridge")
        lp11.place(x=350, y=30)
        
        lp12= Label(Fr5, font=("Segoe UI",10), text=cov8[:7], bd=1, relief="ridge")
        lp12.place(x=350, y=60)
        
        lp13= Label(Fr5, font=("Segoe UI",10), text=cov9[:7], bd=1, relief="ridge")
        lp13.place(x=350, y=90)
        
        lq1= Label(Fr5, font=("Segoe UI",10), text='Koefisien Korelasi \n Image 2', bd=1, relief="ridge")
        lq1.place(x=450, y=50)
        
        ls4= Label(Fr5, font=("Segoe UI",10), text='R', bd=1, relief="ridge")
        ls4.place(x=570, y=30)
        
        ls5= Label(Fr5, font=("Segoe UI",10), text='G', bd=1, relief="ridge")
        ls5.place(x=570, y=60)
        
        ls6= Label(Fr5, font=("Segoe UI",10), text='B', bd=1, relief="ridge")
        ls6.place(x=570, y=90)
        
        lq2= Label(Fr5, font=("Segoe UI",10), text='Horizontal', bd=1, relief="ridge")
        lq2.place(x=600, y=0)
        
        lq3= Label(Fr5, font=("Segoe UI",10), text='Vertikal', bd=1, relief="ridge")
        lq3.place(x=700, y=0)
        
        lq4= Label(Fr5, font=("Segoe UI",10), text='Diagonal', bd=1, relief="ridge")
        lq4.place(x=800, y=0)
        
        lq5= Label(Fr5, font=("Segoe UI",10), text=stg1[:7], bd=1, relief="ridge")
        lq5.place(x=600, y=30)
        
        lq6= Label(Fr5, font=("Segoe UI",10), text=stg2[:7], bd=1, relief="ridge")
        lq6.place(x=600, y=60)
        
        lq7= Label(Fr5, font=("Segoe UI",10), text=stg3[:7], bd=1, relief="ridge")
        lq7.place(x=600, y=90)
        
        lq8= Label(Fr5, font=("Segoe UI",10), text=stg4[:7], bd=1, relief="ridge")
        lq8.place(x=700, y=30)
        
        lq9= Label(Fr5, font=("Segoe UI",10), text=stg5[:7], bd=1, relief="ridge")
        lq9.place(x=700, y=60)
        
        lq10= Label(Fr5, font=("Segoe UI",10), text=stg6[:7], bd=1, relief="ridge")
        lq10.place(x=700, y=90)
        
        lq11= Label(Fr5, font=("Segoe UI",10), text=stg7[:7], bd=1, relief="ridge")
        lq11.place(x=800, y=30)
        
        lq12= Label(Fr5, font=("Segoe UI",10), text=stg8[:7], bd=1, relief="ridge")
        lq12.place(x=800, y=60)
        
        lq13= Label(Fr5, font=("Segoe UI",10), text=stg9[:7], bd=1, relief="ridge")
        ...
        def psnr(a, b, c, d, e, f):
            ...
            nilaip = str(nilaip)
            mse = str(mse)
            lm = Label(Fr5, font=("Segoe UI",10), text='Nilai MSE: ' +' '+ mse[:7], bd=1, relief="ridge")
            lm.place(x=900, y=50)
            lp = Label(Fr5, font=("Segoe UI",10), text='Nilai PSNR: ' +' '+ nilaip[:7], bd=1, relief="ridge")
    ...
    x1 = Button(Frr2,padx=15, pady=8, bd=1, relief="ridge", bg="#e1e7ed", activebackground="#cfd8e3", fg="black", font=("Segoe UI",10), width=15, text="Pilih Citra 1", command = gambar1)
    x1.grid(row=1,column=2)
    
    x2 = Button(Frr2,padx=15, pady=8, bd=1, relief="ridge", bg="#e1e7ed", activebackground="#cfd8e3", fg="black", font=("Segoe UI",10), width=15, text="Pilih Citra 2", command = gambar2)
    x2.grid(row=1,column=4)
    
    x3 = Button(Frr3,padx=15, pady=8, bd=1, relief="ridge", bg="#e1e7ed", activebackground="#cfd8e3", fg="black", font=("Segoe UI",10), width=15, text="Uji Statistik", command = hasil)
    x3.pack()
    
    x4 = Button(Frr3,padx=15, pady=8, bd=1, relief="ridge", bg="#e1e7ed", activebackground="#cfd8e3", fg="black", font=("Segoe UI",10), width=15, text="Keluar", command = statt.destroy)
    x4.pack()
...
def pencet4():
    ...
    Judul1 = Label(Frr1, font=("Segoe UI",15), text=" Uji Keacakan (Distribusi Korelasi)", bd=1, relief="ridge")
    Judul1.pack()
    ...
    def hasil():
        ...
        box = Label(Fr1, font=("Arial, 18"),  text = 'Uji Korelasi Pearson')
        box.grid(row = 0, column = 2)
        
        boa = Label(Fr1, font=("Arial, 14"), text = 'Horizontal                    ')
        boa.grid(row = 1, column = 0) 
        
        bob = Label(Fr1, font=("Arial, 14"), text = 'Vertikal')
        bob.grid(row = 1, column = 2) 
        
        boc = Label(Fr1, font=("Arial, 14"), text = '                      Diagonal')
        ...
        plt.scatter(x_horr, y_horr, color = 'red', s=1)
        plt.savefig('Tempat_gambar/Red Hor.png')
        plt.close()
        
        plt.figure(figsize=(6, 6))
        plt.scatter(x_verr, y_verr, color = 'red', s=1)
        plt.savefig('Tempat_gambar/Red Ver.png')
        plt.close()
        
        plt.figure(figsize=(6, 6))
        plt.scatter(x_diar, y_diar, color = 'red', s=1)
        plt.savefig('Tempat_gambar/Red Dia.png')
        plt.close()
        
        plt.figure(figsize=(6, 6))
        plt.scatter(x_horg, y_horg, color = 'green', s=1)
        plt.savefig('Tempat_gambar/Green Hor.png')
        plt.close()
        
        plt.figure(figsize=(6, 6))
        plt.scatter(x_verg, y_verg, color = 'green', s=1)
        plt.savefig('Tempat_gambar/Green Ver.png')
        plt.close()
        
        plt.figure(figsize=(6, 6))
        plt.scatter(x_diag, y_diag, color = 'green', s=1)
        plt.savefig('Tempat_gambar/Green Dia.png')
        plt.close()
        
        plt.figure(figsize=(6, 6))
        plt.scatter(x_horb, y_horb, color = 'blue', s=1)
        plt.savefig('Tempat_gambar/Blue Hor.png')
        plt.close()
        
        plt.figure(figsize=(6, 6))
        plt.scatter(x_verb, y_verb, color = 'blue', s=1)
        plt.savefig('Tempat_gambar/Blue Ver.png')
        plt.close()
        
        plt.figure(figsize=(6, 6))
        plt.scatter(x_diab, y_diab, color = 'blue', s=1)
    ...
    x1 = Button(Frr2,padx=15, pady=8, bd=1, relief="ridge", bg="#e1e7ed", activebackground="#cfd8e3", fg="black", font=("Segoe UI",10), width=17, text="Pilih File Citra", command = gambar1)
    x1.grid(row=1,column=2)
    
    x3 = Button(Frr3,padx=15, pady=8, bd=1, relief="ridge", bg="#e1e7ed", activebackground="#cfd8e3", fg="black", font=("Segoe UI",10), width=17, text="Uji Distribusi Korelasi", command = hasil)
    x3.pack()
    ...
    x4 = Button(Frr4,padx=15, pady=8, bd=1, relief="ridge", bg="#e1e7ed", activebackground="#cfd8e3", fg="black", font=("Segoe UI",10), width=10, text="Keluar", command = statt.destroy)
    x4.pack()
...
def pencet5():    
    ...
    Judul1 = Label(Frr1, font=("Segoe UI",15), text="Uji Statistik (Uniform, Entropi, UACI, dan NPCR)", bd=1, relief="ridge")
    Judul1.pack()
    ...
    x4 = Button(Frr4,padx=15, pady=8, bd=1, relief="ridge", bg="#e1e7ed", activebackground="#cfd8e3", fg="black", font=("Segoe UI",10), width=15, text= "Keluar", command = statt.destroy)
    x4.pack()
...
roota = Tk()
roota.tk_setPalette(background="#f4f6f9", foreground="#2d3748", activeBackground="#e2e8f0", activeForeground="#1a202c")
...
L1 = Label(F11, text = 'Kriptografi Berbasis Modulo Sine-PWLCM', font = ("Segoe UI", 18))
L1.place(x = 40, y = 25)
...
tampilan1.place(x = 110, y = 25)

tombol1 = Button(F212, text = "Enkripsi", padx=15, pady=8, bd=1, relief="ridge", bg="#e1e7ed", activebackground="#cfd8e3", command = pencet1)
tombol1.place(x = 90, y = 65, width=100)

tombol2 = Button(F212, text = "Dekripsi", padx=15, pady=8, bd=1, relief="ridge", bg="#e1e7ed", activebackground="#cfd8e3", command = pencet2)
tombol2.place(x = 210, y = 65, width=100)

tampilan2 = Label(F212, text = "Uji Kualitas", font = ("Segoe UI", 15))
tampilan2.place(x = 145, y = 140)

tombol3 = Button(F212, text = "Uji Kualitas\nCitra 1", padx=15, pady=8, bd=1, relief="ridge", bg="#e1e7ed", activebackground="#cfd8e3", command = pencet3)
tombol3.place(x = 90, y = 175, width=100)

tombol4 = Button(F212, text = "Uji Kualitas\nCitra 2", padx=15, pady=8, bd=1, relief="ridge", bg="#e1e7ed", activebackground="#cfd8e3", command = pencet4)
tombol4.place(x = 210, y = 175, width=100)

tombol5 = Button(F212, text = "Uji Kualitas\nCitra 3", padx=15, pady=8, bd=1, relief="ridge", bg="#e1e7ed", activebackground="#cfd8e3", command = pencet5)
tombol5.place(x = 150, y = 245, width=100)

tombol6 = Button(F212, text = "Keluar", padx=15, pady=8, bd=1, relief="ridge", bg="#e1e7ed", activebackground="#cfd8e3", command = roota_destroy)
tombol6.place(x = 150, y = 310, width=100)
